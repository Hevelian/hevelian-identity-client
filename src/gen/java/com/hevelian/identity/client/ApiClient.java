...
package com.hevelian.identity.client;
...
import com.hevelian.identity.client.auth.Authentication;
import com.hevelian.identity.client.auth.HttpBasicAuth;
import com.hevelian.identity.client.auth.ApiKeyAuth;
import com.hevelian.identity.client.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://localhost:8082/identity-server/api";
    ...
    public ApiClient() {
        ...
        authentications.put("default", new HttpBasicAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://localhost:8082/identity-server/api
